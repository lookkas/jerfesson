        ...
        <div class="col-md-8">
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        ...
                        <textarea id="textarea1"  class="form-control" class="materialize-textarea" name="comentario"  value="{{isset($registro->comentario)? $registro->comentario:''}}{{ old('comentario') }}" ></textarea>
                    </div>
                </div>
